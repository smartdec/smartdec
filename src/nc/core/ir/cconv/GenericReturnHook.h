...
/**
 * GenericReturnHook is a ReturnHook for a typical calling convention using registers and stack to pass arguments.
 */
class GenericReturnHook: public ReturnHook {
    /** Address analyzer. */
...
public:
     ...
     */
    GenericReturnHook(const Return *ret, const GenericDescriptorAnalyzer *addressAnalyzer);

    /**
     * Destructor.
     */
    virtual ~GenericReturnHook();
