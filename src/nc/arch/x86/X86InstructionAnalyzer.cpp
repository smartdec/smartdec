...
NC_DEFINE_REGISTER_EXPRESSION(zf)
NC_DEFINE_REGISTER_EXPRESSION(sf)
NC_DEFINE_REGISTER_EXPRESSION(of)
NC_DEFINE_REGISTER_EXPRESSION(af)
NC_DEFINE_REGISTER_EXPRESSION(df)
NC_DEFINE_REGISTER_EXPRESSION(flags)
NC_DEFINE_REGISTER_EXPRESSION(eflags)
NC_DEFINE_REGISTER_EXPRESSION(rflags)
...
NC_DEFINE_REGISTER_EXPRESSION(rcx)
